...
entity ContractWorkspaces_AN: managed,types.customFields  {
    ...
    key Realm                           : String(50);
        ...
        Commodity                       : Composition of many ContractWorkspaces_Commodity_AN on Commodity.ContractWorkspace = $self;
        Organization                    : Composition of many ContractWorkspaces_Organization_AN on Organization.ContractWorkspace = $self;
        Region                          : Composition of many ContractWorkspaces_Region_AN on Region.ContractWorkspace = $self;
        AffectedParties                 : Composition of many ContractWorkspaces_AffectedParties_AN on AffectedParties.ContractWorkspace = $self;
        AllOwners                       : Composition of many ContractWorkspaces_AllOwners_AN on AllOwners.ContractWorkspace = $self;
