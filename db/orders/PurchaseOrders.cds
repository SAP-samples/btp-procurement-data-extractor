...
entity PurchaseOrder: managed, types.customFields {
    key Realm                               : String(50);
    key UniqueName                          : String(50);
        ...
        LineItems                           : Composition of many PurchaseOrder_LineItem on LineItems.PurchaseOrder = $self;

}


entity PurchaseOrder_LineItem: cuid {
    key PurchaseOrder                       : Association to PurchaseOrder;
        ...
        SplitAccountings                    : Composition of many PurchaseOrder_LineItem_SplitAccountings on SplitAccountings.LineItem = $self;

}

entity PurchaseOrder_LineItem_SplitAccountings: cuid {
    key LineItem                    : Association to PurchaseOrder_LineItem;
