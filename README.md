...
This repository contains the sample code for the [Activate the Data Extractor](https://discovery-center.cloud.sap/missiondetail/4133/4366/) Mission in SAP Discovery Center.

_This code is only one part of the mission, so please follow the tutorial before attempting to use this code._

## Requirements
Please see the pre-requisites and the required BTP services in the [Activate the Data Extractor](https://discovery-center.cloud.sap/missiondetail/4133/4366/) Mission in SAP Discovery Center.
