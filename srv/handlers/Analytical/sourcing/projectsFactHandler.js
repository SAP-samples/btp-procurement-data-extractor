    ...
    return new Promise(async function(resolve, reject)    {
        ...
        for(const oData of aData) {
            ...
            try {
                ...
                let res =  await SELECT.from ("sap.ariba.Projects_AN").where(
                    {
                ...
                if(res.length==0){
                     //New record, insert
                    await INSERT .into ("sap.ariba.Projects_AN") .entries (oDataCleansed) ;
                    ...
                    await UPDATE ("sap.ariba.Projects_AN") .set (oDataCleansed) .where(
                        {
                            Realm : oDataCleansed.Realm ,
                            ProjectId : oDataCleansed.ProjectId
                        });
...
async function _FullLoadRegions(regions, Realm, ProjectId) {
    return new Promise(async (resolve,reject) =>{
        //Delete old records
        try {
            await DELETE("sap.ariba.Projects_Region_AN").where({
        ...
        for (const re of regions){
            try {
                ...
                await INSERT .into ("sap.ariba.Projects_Region_AN") .entries (re) ;
...
async function _FullLoadOrganizations(organizations, Realm, ProjectId) {
    return new Promise(async (resolve,reject) =>{
        //Delete old records
        try {
            await DELETE("sap.ariba.Projects_Organization_AN").where({
                Projects_Realm : Realm ,
                Projects_ProjectId : ProjectId
            });
        }
        ...
        for (const org of organizations){
            try {
                ...
                await INSERT .into ("sap.ariba.Projects_Organization_AN") .entries (org) ;
...
async function _FullLoadCommodities(commodities, Realm, ProjectId) {
    return new Promise(async (resolve,reject) =>{
        //Delete old records
        try {
            await DELETE("sap.ariba.Projects_Commodity_AN").where({
                Projects_Realm : Realm ,
                Projects_ProjectId : ProjectId
            });
        }
        ...
        for (const co of commodities){
            try {
                ...
                await INSERT .into ("sap.ariba.Projects_Commodity_AN") .entries (co) ;
...
async function _FullLoadAllOwners(allOwners, Realm, ProjectId) {
    return new Promise(async (resolve,reject) =>{
        //Delete old records
        try {
            await DELETE("sap.ariba.Projects_AllOwners_AN").where({
                Projects_Realm : Realm ,
                Projects_ProjectId : ProjectId
            });
        }
        ...
        for (const all of allOwners){
            try {
                ...
                await INSERT .into ("sap.ariba.Projects_AllOwners_AN") .entries (all) ;
